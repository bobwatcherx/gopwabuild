...
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/gopwabuild","GOAPP_STATIC_RESOURCES_URL":"/gopwabuild","GOAPP_VERSION":"f51722db38c704d0eaae43f0fa541c061990b7b0"};
...
async function goappInitWebAssembly() {
  ...
  try {
    ...
    const wasm = await instantiateStreaming(
      fetchWithProgress("/gopwabuild/web/app.wasm", showProgress),
      go.importObject
    );
